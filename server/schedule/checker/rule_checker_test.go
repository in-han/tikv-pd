...
// Ref https://github.com/tikv/pdv9/issues/3521
...
// See issue: https://github.com/tikv/pdv9/issues/3705
...
func (suite *ruleCheckerTestSuite) TestRuleCache() {
	...
	for _, testCase := range testCases {
		...
		if testCase.stillCached {
			suite.NoError(failpoint.Enable("github.com/tikv/pdv9/server/schedule/checker/assertShouldCache", "return(true)"))
			suite.rc.Check(testCase.region)
			suite.NoError(failpoint.Disable("github.com/tikv/pdv9/server/schedule/checker/assertShouldCache"))
		} else {
			suite.NoError(failpoint.Enable("github.com/tikv/pdv9/server/schedule/checker/assertShouldNotCache", "return(true)"))
			suite.rc.Check(testCase.region)
			suite.NoError(failpoint.Disable("github.com/tikv/pdv9/server/schedule/checker/assertShouldNotCache"))
		}
	}
}

// Ref https://github.com/tikv/pdv9/issues/4045
...
// Ref https://github.com/tikv/pdv9/issues/4140
