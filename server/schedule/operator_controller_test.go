...
func (suite *operatorControllerTestSuite) TestCheckAddUnexpectedStatus() {
	suite.NoError(failpoint.Disable("github.com/tikv/pdv9/server/schedule/unexpectedOperator"))
...
func (suite *operatorControllerTestSuite) TestConcurrentRemoveOperator() {
	...
	suite.NoError(failpoint.Enable("github.com/tikv/pdv9/server/schedule/concurrentRemoveOperator", "return(true)"))
