...
func (suite *operatorControllerTestSuite) SetupSuite() {
	...
	suite.NoError(failpoint.Enable("github.com/tikv/pdv2/server/schedule/unexpectedOperator", "return(true)"))
}
...
func (suite *operatorControllerTestSuite) TestCheckAddUnexpectedStatus() {
	suite.NoError(failpoint.Disable("github.com/tikv/pdv2/server/schedule/unexpectedOperator"))
...
func (suite *operatorControllerTestSuite) TestConcurrentRemoveOperator() {
	...
	suite.NoError(failpoint.Enable("github.com/tikv/pdv2/server/schedule/concurrentRemoveOperator", "return(true)"))
