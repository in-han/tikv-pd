...
func TestGetVersion(t *testing.T) {
	// TODO: enable it.
	t.Skip("Temporary disable. See issue: https://github.com/tikv/pdv9/issues/1893")
	re := require.New(t)
	...
	go func(cfg *config.Config) {
		...
		re.NoError(err)
		re.NoError(failpoint.Enable("github.com/tikv/pdv9/server/memberNil", `return(true)`))
		reqCh <- struct{}{}
		err = s.Run()
		re.NoError(err)
		ch <- s
	...
	re.NoError(failpoint.Disable("github.com/tikv/pdv9/server/memberNil"))
}
