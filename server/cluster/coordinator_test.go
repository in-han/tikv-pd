...
func TestCheckCache(t *testing.T) {
	...
	re.NoError(tc.addLeaderRegion(1, 2, 3))
	re.NoError(failpoint.Enable("github.com/tikv/pdv9/server/cluster/break-patrol", `return`))
	...
	co.wg.Wait()
	re.NoError(failpoint.Disable("github.com/tikv/pdv9/server/cluster/break-patrol"))
}
